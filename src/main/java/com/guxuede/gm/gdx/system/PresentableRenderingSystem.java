    ...
    protected void processEntity(Entity entity, float deltaTime) {
        ...
        if (textureRegion != null) {
            if (textureRegion instanceof GdxSprite) {
                ...
                batch.draw(textureRegion, positionComponent.position.x, positionComponent.position.y, presentableComponent.originX, presentableComponent.originY, textureRegion.getRegionWidth(), textureRegion.getRegionHeight(), presentableComponent.scaleX, presentableComponent.scaleY, presentableComponent.rotation);
            }
        }
    }
